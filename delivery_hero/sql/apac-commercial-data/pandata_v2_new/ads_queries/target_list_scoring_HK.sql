...
2) CHANGE FILTERING IN LINE 283
...
WITH prefinal as (
SELECT *
FROM pandata_ap_commercial.monthly_target_list_HK_V2 
...
where owner_name IN ("Colman Lam","Rico Chan")
