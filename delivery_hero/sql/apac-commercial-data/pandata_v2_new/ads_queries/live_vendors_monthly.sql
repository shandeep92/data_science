...
CASE WHEN sf.vendor_grade IS NULL then "Null" else sf.vendor_grade end as vendor_grade,
...
LEFT JOIN dvzone1 dvz ON dvz.global_entity_id = v.global_entity_id AND dvz.vendor_code = v.vendor_code
